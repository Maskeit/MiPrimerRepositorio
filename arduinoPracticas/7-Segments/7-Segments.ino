...
void setup() {
  byte Numdigits=4;
  byte Comunes[]={2,3,4,5}; //el acomodo de los digitos, lo puedes experimentar a,b,c,d,e,f,g
...
void loop() {
    ...
    if(millis()>=tiempoejec){
      ...
      contador++;
      if(contador==10000){ //el limite al cual se reinicia el contador, este lo puedes ajustar al gusto
